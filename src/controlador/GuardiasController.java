...
public class GuardiasController {
    ...
    private void configurarColumnasTabla() {
        ...
        // Botón de acción para asignar guardia
    ...
    private void cargarGuardiasDisponibles() {
        ...
        String sql = "SELECT g.id, g.docente_id, d.nom, d.cognom1, d.cognom2, g.fecha, " +
                     ...
                     "AND g.docente_id != ? " +  // Excluir guardias del propio docente
                     "AND (g.docente_sustituto IS NULL OR g.docente_sustituto != ?)"; // Excluir guardias ya asignadas

        if (dpFechaFiltro.getValue() != null) {
            sql += " AND g.fecha = ?";
        }
