...
//================================================================================================
 ...
 //=============================================================================================================}
    ...
    private void reportarInasistencia() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/front/falta.fxml"));
            Parent root = loader.load();
            
            InasistenciaController controller = loader.getController();
            ...
            mostrarError("Error al abrir formulario de inasistencia: " + e.getMessage());
        }
    }
    ...
    private void cerrarSesion() {
        ...
        if (confirmacion.showAndWait().orElse(ButtonType.CANCEL) == ButtonType.OK) {
            try {
                // Registrar el logout (archivo y BD)
 ...
 //==================================================================================================================================
  ...
  private void iniciarRecordatorioJornada() {
	    ...
	    // Verificar inmediatamente al iniciar por si acaso
	    verificarHoraSalida();
	}
